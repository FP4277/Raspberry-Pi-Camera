        ...
        while True:
            ...
            if self.preview_enabled and not self.viewing:
                try:
                    ...
                    # Help overlay (bottom text guide)
                    if self.help_overlay:
                        draw.rectangle((0, 165, 320, 240), fill=(0, 0, 0))
                        help_lines = [
                            "A: Photo  B: Gallery  X: ◀  Y: ▶",
                            "Double: Settings, Adjust, AF, Shutdown"
                        ]
                        y_start = 170
                        for line in help_lines:
                            draw.text((10, y_start), line, font=font, fill=(255, 255, 255))
                            y_start += 20
    ...
    def adjust_setting(self):
        ...
        if item == "Brightness":
            ...
            if self.control_mode == "manual":
                ...
                try: i = speeds.index(self.shutter_speed)
                except: i = -1
